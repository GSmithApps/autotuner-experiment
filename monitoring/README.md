...
and the sticky cache size

```
sum by (namespace, task_queue) (temporal_sticky_cache_size)
```

You can also make a dashboard with the following
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "editorMode": "code",
          "expr": "sum by (namespace, task_queue) (temporal_worker_task_slots_available)\n",
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "editorMode": "code",
          "expr": "sum by (namespace, task_queue) (temporal_worker_task_slots_used)\n",
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "editorMode": "code",
          "expr": "sum by (namespace, task_queue) (temporal_sticky_cache_size)\n",
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
        }
